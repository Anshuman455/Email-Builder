...
export const EDITOR_ICONS = {
  ...
  format_bold: svg(`<path d="M7 5h5.5a3.5 3.5 0 0 1 0 7H7Z"/><path d="M7 12h6.5a3.5 3.5 0 0 1 0 7H7Z"/>`),
  format_italic: svg(`<path d="M19 4h-8M13 20H5M15 4 9 20"/>`),
  format_underlined: svg(`<path d="M7 4v7a5 5 0 0 0 10 0V4"/><path d="M5 20h14"/>`),
  strikethrough_s: svg(`<path d="M16.5 7.5C16 5.9 14.3 5 12 5c-2.7 0-4.5 1.3-4.5 3.2 0 1.3.9 2.2 2.3 2.8"/><path d="M4 12h16"/><path d="M7.5 16.5C8 18.1 9.7 19 12 19c2.7 0 4.5-1.3 4.5-3.2 0-.6-.2-1.2-.6-1.6"/>`),
